...
window.addEventListener("DOMContentLoaded", () => {
  ...
  overlay1_canvas.addEventListener("mousedown", (e) => {
    if (e.button == 2) {
      react_for_selection_option_refus(e);
    }
  });
...
function react_for_cursor_moveOut_selection(e) {
  ...
  selection_options.style.cursor = "default";
  // }
}
...
function react_for_selection_mouseup(e) {
  ...
  if (judge_event_in_area(e)) {
    ...
    if (
      selection_top + parseInt(selection.style.height, 10) + 22 >
      overlay1_canvas.height
    ) {
      console.log("selection_options 朝上");
      selection_options.classList.toggle("onTop");
    } else {
      console.log("selection_options 朝下");
